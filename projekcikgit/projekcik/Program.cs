...
namespace projekcik
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Klient klient1 = new Klient("Marek", "Nowak", "23456789012", 888999111, 18, "bbb@abc.com", "1", 32);
            //Console.WriteLine(klient1);
            Klient klient2 = new Klient("Anita", "Zielona", "34567890123", 777888999, 21, "ccc@abc.com", "2", 21);
            //Console.WriteLine(klient2);
            //Console.WriteLine("Ilość klientów: {0}", Klient.licznik_klientow);

            Pracownik pracownik1 = new Pracownik("Paweł", "Jumper", "45678901234", 666777888, 33, "ddd@abc.com", "1");
            //Console.WriteLine(pracownik1);
            Pracownik pracownik2 = new Pracownik("Juliusz", "Cezar", "56789012345", 767878989, 27, "eee@abc.com", "2");
